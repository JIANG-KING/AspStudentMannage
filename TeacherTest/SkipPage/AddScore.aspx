<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddScore.aspx.cs" Inherits="AdminTest_SkipPage_AddScore" %>
    ...
    <table class="auto-style1"align="center">
        <tr>
            ...
            <td class="auto-style5" colspan="2">
                <asp:DropDownList ID="DropDownListCourseId" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListCourseId_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td>
                &nbsp;</td>
