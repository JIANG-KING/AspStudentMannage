        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style10">
                    <asp:GridView ID="GridViewScore" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="301px" Width="759px" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" Font-Size="Smaller">
                        <Columns>
                            <asp:BoundField HeaderText="课程" DataField="name" />
                            <asp:BoundField HeaderText="学生" DataField="studentname" />
