<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateStudent.aspx.cs" Inherits="AdminTest_SkipPage_AddStudent" %>
...
<body style="height: 479px">
    ...
    <table class="auto-style1"align="center">
        <tr>
            <td class="auto-style3" style="font-family: 微软雅黑; color: #3366FF">学号：</td>
            <td class="auto-style5" colspan="2">
                <asp:TextBox ID="TextBoxID" runat="server"></asp:TextBox>
            </td>
            <td style="font-family: 微软雅黑; color: #FF0000">
                <asp:RequiredFieldValidator ID="RFVID" runat="server" ControlToValidate="TextBoxID" Display="Dynamic" ErrorMessage="请输入学号！"></asp:RequiredFieldValidator>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style3" style="font-family: 微软雅黑; color: #3366FF">班级：</td>
            <td class="auto-style5" colspan="2">
        ...
        <tr>
            <td class="auto-style3" style="font-family: 微软雅黑; color: #3366FF">专业：</td>
            <td class="auto-style5" colspan="2">
        ...
        <tr>
            <td class="auto-style7" style="font-family: 微软雅黑; color: #3366FF">出生年月：</td>
            <td class="auto-style8" colspan="2">
                <asp:TextBox ID="TextBoxBirth" runat="server" TextMode="Date" ></asp:TextBox>
            </td>
            <td style="font-family: 微软雅黑; color: #FF0000" class="auto-style9">
